...
namespace hi_im_gosu
{
    class Vayne
    {
        ...
        public static hi_im_gosu.Orbwalking.Orbwalker orbwalker;
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            orbwalker = new hi_im_gosu.Orbwalking.Orbwalker(menu.SubMenu("Orbwalker"));
            ...
            menu.AddItem(new MenuItem("NoAAStealth", "Don't AA while stealthed for first ms").SetValue( new Slider( 0, 0, 1000 ) ));
            menu.AddItem(
            ...
            menu.AddItem(new MenuItem("QLasthit", "Use Q LastHit").SetValue(true));
        ...
        {
            if( Q.IsReady() && menu.Item("QLasthit").GetValue<bool>() )
            {
        ...
        private static void checkAAStealth()
        {
            bool CanAttack = !(Player.Buffs.Any(buff => buff.Name == "vaynetumblefade" & buff.IsActive && buff.EndTime - Game.Time >= 1f - (float)menu.Item("NoAAStealth").GetValue<Slider>().Value/1000f ));
