    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
                    new MenuItem("LaneFreeze", "LaneFreeze").SetShared().SetValue(new KeyBind('A', KeyBindType.Press)));
                _config.AddItem(
                    new MenuItem("FreezeHP", "Kill minions when HP < ").SetShared().SetValue(new Slider(50, 1, 300)));
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    {
                        return OrbwalkingMode.LaneFreeze;
                    }
            ...
            public AttackableUnit GetTarget()
            {
                ...
                if (ActiveMode == OrbwalkingMode.LaneClear || ActiveMode == OrbwalkingMode.Mixed ||
                    ActiveMode == OrbwalkingMode.LastHit || ActiveMode == OrbwalkingMode.LaneFreeze )
                {
                        ...
                        )
                    {
                        ...
                        if (minion.Team != GameObjectTeam.Neutral && MinionManager.IsMinion(minion, true))
                        {
                            ...
                            if (predHealth > 0 && predHealth <= Player.GetAutoAttackDamage(minion, true) && ( ActiveMode != OrbwalkingMode.LaneFreeze || predHealth <= _config.Item("FreezeHP").GetValue<Slider>().Value ) )
                            {
                                return minion;
                            }
                        }
                ...
                /*Champions*/
                if (ActiveMode != OrbwalkingMode.LastHit && ActiveMode != OrbwalkingMode.LaneFreeze)
                {
                    var target = TargetSelector.GetTarget(-1, TargetSelector.DamageType.Physical);
                    if (target.IsValidTarget())
                    {
