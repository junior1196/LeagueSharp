  ...
  class Program
  {
      ...
      static void setupMessages()
      {
          Messages = new List<string>
          {
              "Buena", 
              "Bien pt", 
              "mira como que tan descarado ks", 
              "dale que les hacemos carrito",
              "buenaaaaaaa", 
              "no te hagas el pro eso fue suerte",
              "vamooos campeon",
              "dale daleee!",
              "bien",
              "joyaaa", 
              "noo mira el noob estee",
              "te sigo, dale",
              "a quien le dices", 
              "tengo lag adios al carrito",
          };
