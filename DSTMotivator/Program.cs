...
namespace DSTMotivator
{
  class Program
  {
      ...
      static void setupMessages()
      {
          ...
          {
              "Buena", "Bien pt", "mira como kseaaa esteee!!", "dalre que le hacemos carrito",
              "buenaaaaaaa", "se hace el pro el suertudo este",
              "vamooos bigotudoo",
              "dale daleee!",
              "tengo demasiado lag disculpen si me dejo de mover",
              "6mil de pin rito pls",
              "bien", "joyaaa", "noo mira el pt estee",
              "te sigo, dale",
              "como?",              
          };
          ...
          {
              "",
              " dale tira el nexus", " sigue con el ks y me voy afk",
              " dat lagasoo"," dale que me hago un penta", " dale gato",
              " vamoo vamoooo!!"
          };
          ...
          {
              "suerte bigotes", "Vamos que me toco todos pts",
              "que easy partida", "buen team",
              "gl hf", "gl and hf", "gl & hf",
              "Buen trabajo",
              "Todos estan jugando bien",
