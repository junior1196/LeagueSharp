...
namespace DSTMotivator
{
  class Program
  {
      ...
      static void setupMessages()
      {
          ...
          {
              "Buena", "Bien pt", "mira como kseaaa esteee!!", "dalre que le hacemos la cola",
              "buenaaaaaaa", "se hace el pro el manko",
              "vamooo bigotudoo",
              "dale daleee!",
          ...
          {
              "",
              " dale tira goma", " segui con el ks y me voy afk",
              " dat lagasoo"," dale que los garchamos bajo torre", " dale gato",
              " vamoo vamoooo!!"
          };
          ...
          Greetings = new List<string>
          {
              ...
              "que gilada de partida", "buen team",
